...
start:             
    ...
    start_os_intro db 'FabienRHACK System v1.0',0
    press_key db '>>>> Appuyer ici <<<<',0

    login_username db 'Username : ',0
    login_password db 'Password : ',0
    
    display_text db 'Mon premier Systeme d exploitation', 0

    os_info db 10, 'Mon premier System OS, 16-Bit, version=1.0.0',13,0

    press_key_2 db 10,'Entrer ici',0

    window_text db 10,'FabienRHACK SYSTEM', 0
    hello_world_text db 10,10, '    FabienRHACK OS!',0
    login_label db '#] Quitter....(Echap pour quitter)', 0
